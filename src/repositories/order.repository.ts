...
> {
  ...
  constructor(
    @inject('datasources.dbpostgresql') dataSource: DbpostgresqlDataSource, @repository.getter('CustomerRepository') protected customerRepositoryGetter: Getter<CustomerRepository>, @repository.getter('ManufacturerRepository') protected manufacturerRepositoryGetter: Getter<ManufacturerRepository>,
  ) {
